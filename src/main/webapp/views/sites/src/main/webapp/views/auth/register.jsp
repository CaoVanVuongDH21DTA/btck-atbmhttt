...
<body>
	...
	<div class="main-w3layouts wrapper">
		...
		<div class="main-agileinfo">
			<div class="agileits-top">
				...
				<c:if test="${ not empty message}">
					...
					<label class="form-check-label" for="inlineRadio1">Tên Đăng Nhập</label>
				...
				<p>
					Have an Account? <a href="/java-assignment/LoginServlet"> Login
						Now!</a>
				</p>
			</div>
		</div>
		...
		<ul class="colorlib-bubbles">
			...
			<li>Lê Phạm Hưng Hà <br/> 21130045</li>
		</ul>
	</div>
	<!-- //main -->
</body>
