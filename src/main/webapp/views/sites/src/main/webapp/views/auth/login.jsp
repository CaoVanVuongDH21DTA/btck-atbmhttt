...
.colorlib-bubbles li {
	...
	-moz-animation: square 20s infinite;
	...
	<div class="main-w3layouts wrapper">
		...
		<div class="main-agileinfo">
			<div class="agileits-top">
				<form action="/java-assignment/LoginServlet" method="post">
				...
				<p>
					Don't have an Account? <a href="/java-assignment/RegisterServlet">
						Register Now!</a>
				</p>
				<p>
					<a href="/java-assignment/AdminSigninServlet">
						Sign in as Admin!</a>
				</p>
			</div>
		</div>
		...
		<div class="colorlibcopy-agile">
			<p>© 2021 Đại Học Nông Lâm</p>
		</div>
		<!-- //copyright -->
		<ul class="colorlib-bubbles">
			<li>Cao Văn Vượng - 21130253</li>
			<li>Lê Phạm Hưng Hà - 21130045</li>
		</ul>
	</div>
	<!-- //main -->
</body>
