...
public class EmailService {
	...
	// Phương thức gửi email xác nhận khi người dùng đã nhập publicKey
	public void sendConfirmationEmail(String userEmail, String base64PublicKey) {
	    ...
	    try {
	        ...
	        String content = "<p>Chúc mừng bạn đã đăng ký tài khoản thành công!</p>" +
	                         ...
	                         "<ul>" +
	                         "<li>" + base64PublicKey + "</li>" +
	                         "</ul>" +
	                         "<p>Hãy nhớ bảo quản thật tốt privateKey của bạn.</p>";

	        message.setContent(content, "text/html; charset=UTF-8");

	        // Gửi email
	        Transport.send(message);
	        System.out.println("Email xác nhận đăng ký đã gửi thành công đến: " + to);
    ...
    public void sendKey(String userEmail, String base64PrivateKey, String base64PublicKey) {
        ...
        try {
            ...
            String content = "<p>Dưới đây là khóa bí mật và khóa công khai của bạn:</p>" +
			            		"<p>Đây là khóa công khai của bạn: </p>" +
			                    "<ul>" +
			                    "<li>" + base64PublicKey + "</li>" +
			                    "</ul>" +
			                    "<p>Đây là khóa bí mật của bạn: </p>" +
			                    "<ul>" +
			                    "<li>" + base64PrivateKey + "</li>" +
			                    "</ul>" +
			                    "<p>Hãy nhớ giữ thật tốt khóa bí mật của bạn nhé.</p>";
